   ...
   private lazy var textfield: UITextField = {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            textfield.leadingAnchor.constraint(equalTo: textView.leadingAnchor, constant: Space.base02.rawValue),
            textfield.trailingAnchor.constraint(equalTo: textView.trailingAnchor, constant: -Space.base02.rawValue),
